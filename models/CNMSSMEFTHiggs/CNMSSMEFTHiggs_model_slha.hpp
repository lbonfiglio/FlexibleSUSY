...
/**
 * @file CNMSSMEFTHiggs_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Thu 21 Mar 2019 14:21:29

#ifndef CNMSSMEFTHiggs_SLHA_H
#define CNMSSMEFTHiggs_SLHA_H
...
class CNMSSMEFTHiggs_slha : public Model {
public:
   explicit CNMSSMEFTHiggs_slha(const CNMSSMEFTHiggs_input_parameters& input_ = CNMSSMEFTHiggs_input_parameters());
   explicit CNMSSMEFTHiggs_slha(const Model&, bool do_convert_masses_to_slha = true);
   CNMSSMEFTHiggs_slha(const CNMSSMEFTHiggs_slha&) = default;
   CNMSSMEFTHiggs_slha(CNMSSMEFTHiggs_slha&&) = default;
   virtual ~CNMSSMEFTHiggs_slha() = default;
   CNMSSMEFTHiggs_slha& operator=(const CNMSSMEFTHiggs_slha&) = default;
   CNMSSMEFTHiggs_slha& operator=(CNMSSMEFTHiggs_slha&&) = default;
   ...
   const CNMSSMEFTHiggs_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   CNMSSMEFTHiggs_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   CNMSSMEFTHiggs_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
CNMSSMEFTHiggs_slha<Model>::CNMSSMEFTHiggs_slha(const CNMSSMEFTHiggs_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
CNMSSMEFTHiggs_slha<Model>::CNMSSMEFTHiggs_slha(const Model& model_,
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::convert_to_slha()
{
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const CNMSSMEFTHiggs_physical& CNMSSMEFTHiggs_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
CNMSSMEFTHiggs_physical& CNMSSMEFTHiggs_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void CNMSSMEFTHiggs_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void CNMSSMEFTHiggs_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const CNMSSMEFTHiggs_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
