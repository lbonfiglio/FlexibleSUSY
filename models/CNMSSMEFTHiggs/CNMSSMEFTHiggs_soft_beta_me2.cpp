...
// File generated at Thu 21 Mar 2019 14:09:26
 ...
 */
Eigen::Matrix<double,3,3> CNMSSMEFTHiggs_soft_parameters::calc_beta_me2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CNMSSMEFTHiggs_soft_parameters::calc_beta_me2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CNMSSMEFTHiggs_soft_parameters::calc_beta_me2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CNMSSMEFTHiggs_soft_parameters::calc_beta_me2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
Eigen::Matrix<double,3,3> CNMSSMEFTHiggs_soft_parameters::calc_beta_me2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
