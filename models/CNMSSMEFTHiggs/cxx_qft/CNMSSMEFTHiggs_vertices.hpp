...
/**
 * @file cxx_qft/CNMSSMEFTHiggs_vertices.hpp
 *
 * This file was generated at Thu 21 Mar 2019 14:21:52 with FlexibleSUSY
 * 2.3.0 and SARAH 4.12.3 .
 */

#ifndef CNMSSMEFTHiggs_CXXQFT_VERTICES_H
#define CNMSSMEFTHiggs_CXXQFT_VERTICES_H
...
public:
	...
	TripleVectorVertex(const std::complex<double>& v,
		even_permutation ) : val(v), even( true )
	{}
	 ...
	 **/ 
	TripleVectorVertex(const std::complex<double>& v,
		odd_permutation ) : val(v), even( false )
	{}
...
public:
  ...
  : val(v), minuendIndex(mi), subtrahendIndex(si) {}
	...
	int incoming_index( void ) const { return minuendIndex; }
	int outgoing_index( void ) const { return subtrahendIndex; }
