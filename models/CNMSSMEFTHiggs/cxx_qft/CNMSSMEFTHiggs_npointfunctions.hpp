...
/**
 * @file cxx_qft/CNMSSMEFTHiggs_npointfunctions.hpp
 *
 * This file was generated at Thu 21 Mar 2019 14:21:52 with FlexibleSUSY
 * 2.3.0 and SARAH 4.12.3 .
 */

#ifndef CNMSSMEFTHiggs_CXXQFT_NPOINTFUNCTIONS_H
#define CNMSSMEFTHiggs_CXXQFT_NPOINTFUNCTIONS_H

#include "CNMSSMEFTHiggs_qft.hpp"
...
namespace detail
{
  ...
  public:
    ...
    void operator()( InsertionData )
    {
      ...
      value += colour_factor * combinatorial_factor *
        boost::fusion::fused<
  ...
  template<std::intmax_t Num, std::intmax_t Denom = 1> struct ratio_helper
  {
    static constexpr double value = double(Num) / double(Denom);
  };
  
  template<class RealPart, class ImPart> struct complex_helper
  {
...
public:
  correlation_function_context(
    const CNMSSMEFTHiggs_mass_eigenstates &m,
