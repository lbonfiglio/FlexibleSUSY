...
// File generated at Thu 21 Mar 2019 14:09:17
...
const int CNMSSMEFTHiggs_soft_parameters::numberOfParameters;

CNMSSMEFTHiggs_soft_parameters::CNMSSMEFTHiggs_soft_parameters(const CNMSSMEFTHiggs_input_parameters& input_)
   : CNMSSMEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

CNMSSMEFTHiggs_soft_parameters::CNMSSMEFTHiggs_soft_parameters(
   const CNMSSMEFTHiggs_susy_parameters& susy_model
   ...
   : CNMSSMEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd CNMSSMEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

CNMSSMEFTHiggs_soft_parameters CNMSSMEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   ...
   const CNMSSMEFTHiggs_susy_parameters susy_betas(CNMSSMEFTHiggs_susy_parameters::calc_beta(loops));

   return CNMSSMEFTHiggs_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TLambdax, beta_TKappa, beta_TYu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_ms2, beta_MassB, beta_MassWB, beta_MassG);
}

CNMSSMEFTHiggs_soft_parameters CNMSSMEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void CNMSSMEFTHiggs_soft_parameters::clear()
{
   CNMSSMEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd CNMSSMEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(CNMSSMEFTHiggs_susy_parameters::get());
...
void CNMSSMEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   CNMSSMEFTHiggs_susy_parameters::print(ostr);
...
void CNMSSMEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   CNMSSMEFTHiggs_susy_parameters::set(pars);
...
CNMSSMEFTHiggs_soft_parameters::Soft_traces CNMSSMEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const CNMSSMEFTHiggs_soft_parameters& soft_pars)
{
