...
#ifndef CNMSSMEFTHiggs_SLHA_IO_H
#define CNMSSMEFTHiggs_SLHA_IO_H
...
struct CNMSSMEFTHiggs_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class CNMSSMEFTHiggs_slha_io {
public:
   CNMSSMEFTHiggs_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(CNMSSMEFTHiggs_input_parameters&) const;
   void fill(CNMSSMEFTHiggs_mass_eigenstates&) const;
   template <class Model> void fill(CNMSSMEFTHiggs_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const CNMSSMEFTHiggs_slha<Model>&, const CNMSSMEFTHiggs_scales&, const CNMSSMEFTHiggs_observables&);
   void set_input(const CNMSSMEFTHiggs_input_parameters&);
   ...
   template <class Model> void set_spectrum(const CNMSSMEFTHiggs_slha<Model>&);
   template <class T> void set_spectrum(const CNMSSMEFTHiggs<T>&);
   ...
   static void fill_minpar_tuple(CNMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_extpar_tuple(CNMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imminpar_tuple(CNMSSMEFTHiggs_input_parameters&, int, double);
   static void fill_imextpar_tuple(CNMSSMEFTHiggs_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const CNMSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const CNMSSMEFTHiggs_scales&, const CNMSSMEFTHiggs_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const CNMSSMEFTHiggs_slha<Model>&, const softsusy::QedQcd&, const CNMSSMEFTHiggs_scales&, const CNMSSMEFTHiggs_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const CNMSSMEFTHiggs_input_parameters&);
   void set_imminpar(const CNMSSMEFTHiggs_input_parameters&);
   void set_imextpar(const CNMSSMEFTHiggs_input_parameters&);
   void set_minpar(const CNMSSMEFTHiggs_input_parameters&);
   void set_mass(const CNMSSMEFTHiggs_physical&, bool);
   void set_mass(const standard_model::Standard_model_physical&);
   void set_mixing_matrices(const CNMSSMEFTHiggs_physical&, bool);
   void set_mixing_matrices(const standard_model::Standard_model_physical&);
   template <class Model> void set_model_parameters(const CNMSSMEFTHiggs_slha<Model>&);
   void set_model_parameters(const standard_model::Standard_model&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(CNMSSMEFTHiggs_mass_eigenstates&) const;
   void fill_physical(CNMSSMEFTHiggs_physical&) const;
};
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha_io::fill(CNMSSMEFTHiggs_slha<Model>& model) const
{
   fill(static_cast<CNMSSMEFTHiggs_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void CNMSSMEFTHiggs_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CNMSSMEFTHiggs_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const CNMSSMEFTHiggs_scales& scales,
   const CNMSSMEFTHiggs_observables& observables)
{
   CNMSSMEFTHiggs_slha_io slha_io;
   const CNMSSMEFTHiggs_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll CNMSSMEFTHiggs_slha_io::fill_slhaea(
   const CNMSSMEFTHiggs_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const CNMSSMEFTHiggs_scales& scales, const CNMSSMEFTHiggs_observables& observables)
{
   SLHAea::Coll slhaea;
   CNMSSMEFTHiggs_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha_io::set_model_parameters(const CNMSSMEFTHiggs_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha_io::set_extra(
   const CNMSSMEFTHiggs_slha<Model>& model, const CNMSSMEFTHiggs_scales& scales,
   const CNMSSMEFTHiggs_observables& observables)
{
   const CNMSSMEFTHiggs_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void CNMSSMEFTHiggs_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
 ...
 */
template <class T>
void CNMSSMEFTHiggs_slha_io::set_spectrum(const CNMSSMEFTHiggs<T>& model)
{
   set_spectrum(CNMSSMEFTHiggs_slha<CNMSSMEFTHiggs<T> >(model));
}
 ...
 */
template <class Model>
void CNMSSMEFTHiggs_slha_io::set_spectrum(const CNMSSMEFTHiggs_slha<Model>& model)
{
   const CNMSSMEFTHiggs_physical physical(model.get_physical_slha());
