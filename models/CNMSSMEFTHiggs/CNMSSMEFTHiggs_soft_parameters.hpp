...
#ifndef CNMSSMEFTHiggs_soft_parameters_H
#define CNMSSMEFTHiggs_soft_parameters_H
...
class CNMSSMEFTHiggs_soft_parameters : public CNMSSMEFTHiggs_susy_parameters {
public:
   explicit CNMSSMEFTHiggs_soft_parameters(const CNMSSMEFTHiggs_input_parameters& input_ = CNMSSMEFTHiggs_input_parameters());
   CNMSSMEFTHiggs_soft_parameters(const CNMSSMEFTHiggs_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>& TYe_,
   ...
   CNMSSMEFTHiggs_soft_parameters(const CNMSSMEFTHiggs_soft_parameters&) = default;
   CNMSSMEFTHiggs_soft_parameters(CNMSSMEFTHiggs_soft_parameters&&) = default;
   virtual ~CNMSSMEFTHiggs_soft_parameters() = default;
   CNMSSMEFTHiggs_soft_parameters& operator=(const CNMSSMEFTHiggs_soft_parameters&) = default;
   CNMSSMEFTHiggs_soft_parameters& operator=(CNMSSMEFTHiggs_soft_parameters&&) = default;
   ...
   CNMSSMEFTHiggs_soft_parameters calc_beta() const;
   CNMSSMEFTHiggs_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const CNMSSMEFTHiggs_soft_parameters&);
