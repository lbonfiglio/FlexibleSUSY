...
#ifndef CNMSSMEFTHiggs_WEINBERG_ANGLE_H
#define CNMSSMEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class CNMSSMEFTHiggs_weinberg_angle
...
public:
   ...
   CNMSSMEFTHiggs_weinberg_angle(const CNMSSMEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const CNMSSMEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const CNMSSMEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
