...
#ifndef CNMSSMEFTHiggs_PHYSICAL_H
#define CNMSSMEFTHiggs_PHYSICAL_H
...
struct CNMSSMEFTHiggs_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const CNMSSMEFTHiggs_physical&);
