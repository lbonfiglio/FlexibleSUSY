...
// File generated at Thu 21 Mar 2019 14:21:28

/**
 * @file CNMSSMEFTHiggs_mass_eigenstates.cpp
 * @brief implementation of the CNMSSMEFTHiggs model class
 *
 * Contains the definition of the CNMSSMEFTHiggs model class methods
 * which solve EWSB and calculate pole masses and mixings from DRbar
 * parameters.
 *
 * This file was generated at Thu 21 Mar 2019 14:21:28 with FlexibleSUSY
...
#define CLASSNAME CNMSSMEFTHiggs_mass_eigenstates
...
CLASSNAME::CLASSNAME(const CNMSSMEFTHiggs_input_parameters& input_)
   : CNMSSMEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_SEMI_ANALYTIC_SOLVER)
   , ewsb_solver(new CNMSSMEFTHiggs_ewsb_solver<Semi_analytic>())
#endif
{
}
...
const CNMSSMEFTHiggs_physical& CLASSNAME::get_physical() const
{
   return physical;
}

CNMSSMEFTHiggs_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const CNMSSMEFTHiggs_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<CNMSSMEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
int CLASSNAME::solve_ewsb()
{
   ...
   VERBOSE_MSG("\t\tSolving CNMSSMEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "CNMSSMEFTHiggs\n"
           "========================================\n";
   CNMSSMEFTHiggs_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Se);
   if (PHYSICAL(Mhh).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::hh);
   if (PHYSICAL(MAh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::Hpm);
...
{
   CNMSSMEFTHiggs_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   CNMSSMEFTHiggs_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(CNMSSMEFTHiggs_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = CNMSSMEFTHiggs_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = CNMSSMEFTHiggs_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Sd, eigenvalue_error > precision
       * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Sv, eigenvalue_error > precision
       * Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Su, eigenvalue_error > precision
       * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Se, eigenvalue_error > precision
       * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::hh, eigenvalue_error > precision
       * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Ah, eigenvalue_error > precision
       * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Hpm, eigenvalue_error >
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Chi, eigenvalue_error >
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Cha, eigenvalue_error >
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fe, eigenvalue_error > precision
       * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fd, eigenvalue_error > precision
       * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fu, eigenvalue_error > precision
       * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(CNMSSMEFTHiggs_info::VWm);
   }
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::VZ);
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Sd))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZD;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZD,
            eigenvalue_error);
         problems.flag_bad_mass(CNMSSMEFTHiggs_info::Sd, eigenvalue_error >
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Sv))
      return;
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      Eigen::Matrix<double,3,3> mix_ZV;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZV,
            eigenvalue_error);
         problems.flag_bad_mass(CNMSSMEFTHiggs_info::Sv, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Su))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZU;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZU,
            eigenvalue_error);
         problems.flag_bad_mass(CNMSSMEFTHiggs_info::Su, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Se))
      return;
   ...
   for (int es = 0; es < 6; ++es) {
      ...
      Eigen::Matrix<double,6,6> mix_ZE;
         ...
         fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZE,
            eigenvalue_error);
         problems.flag_bad_mass(CNMSSMEFTHiggs_info::Se, eigenvalue_error >
            precision * Abs(eigen_values(0)));
      #else
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::hh))
      return;
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               ...
               problems.flag_bad_mass(CNMSSMEFTHiggs_info::hh);
            }
         }
      }
   }
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZH;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZH,
               eigenvalue_error);
            problems.flag_bad_mass(CNMSSMEFTHiggs_info::hh, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::hh);
}

void CLASSNAME::calculate_MAh_pole()
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Ah))
      return;
   ...
   if (pole_mass_loop_order > 1) {
      ...
      for (int i = 0; i < 3; i++) {
         for (int k = 0; k < 3; k++) {
            if (!std::isfinite(self_energy_2l(i,k))) {
               self_energy_2l(i,k) = 0.;
               problems.flag_bad_mass(CNMSSMEFTHiggs_info::Ah);
            }
         }
      }
   }
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZA;
            ...
            fs_diagonalize_hermitian(M_loop, eigen_values, mix_ZA,
               eigenvalue_error);
            problems.flag_bad_mass(CNMSSMEFTHiggs_info::Ah, eigenvalue_error >
               precision * Abs(eigen_values(0)));
         #else
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::Ah);
   else
      problems.unflag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::Ah);
}

void CLASSNAME::calculate_MHpm_pole()
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::Hpm))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::Hpm);
   else
      problems.unflag_no_pole_mass_convergence(CNMSSMEFTHiggs_info::Hpm);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fe, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fd, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   for (int es = 0; es < 3; ++es) {
      ...
      problems.flag_bad_mass(CNMSSMEFTHiggs_info::Fu, eigenvalue_error >
         precision * Abs(eigen_values(0)));
   #else
...
{
   if (!force_output && problems.is_running_tachyon(CNMSSMEFTHiggs_info::VWm))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(CNMSSMEFTHiggs_info::VWm);
