...
#define CLASSNAME CNMSSMEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::CNMSSMEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const CNMSSMEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const auto gY = MODEL->get_g1() * CNMSSMEFTHiggs_info::normalization_g1;
   const auto g2 = MODEL->get_g2() * CNMSSMEFTHiggs_info::normalization_g2;
