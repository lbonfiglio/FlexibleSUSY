...
// File generated at Thu 21 Mar 2019 14:09:24
 ...
 */
double CNMSSMEFTHiggs_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CNMSSMEFTHiggs_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CNMSSMEFTHiggs_soft_parameters::calc_beta_mHu2_3_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double CNMSSMEFTHiggs_soft_parameters::calc_beta_mHu2_4_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
 ...
 */
double CNMSSMEFTHiggs_soft_parameters::calc_beta_mHu2_5_loop(const Soft_traces& soft_traces) const
{
   DEFINE_PROJECTOR(3,3,3,3)
