...
CNMSSMEFTHiggs_slha_io::CNMSSMEFTHiggs_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void CNMSSMEFTHiggs_slha_io::clear()
{
   slha_io.clear();
}

void CNMSSMEFTHiggs_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_extpar(const CNMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSMEFTHiggs_slha_io::set_imminpar(const CNMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSMEFTHiggs_slha_io::set_imextpar(const CNMSSMEFTHiggs_input_parameters& input)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSMEFTHiggs_slha_io::set_minpar(const CNMSSMEFTHiggs_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void CNMSSMEFTHiggs_slha_io::set_input(const CNMSSMEFTHiggs_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void CNMSSMEFTHiggs_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, CNMSSMEFTHiggs_info::model_name)
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_mass(const CNMSSMEFTHiggs_physical& physical,
 ...
 */
void CNMSSMEFTHiggs_slha_io::set_mixing_matrices(const CNMSSMEFTHiggs_physical& physical,
...
void CNMSSMEFTHiggs_slha_io::set_ckm(
...
void CNMSSMEFTHiggs_slha_io::set_pmns(
...
void CNMSSMEFTHiggs_slha_io::set_model_parameters(const standard_model::Standard_model& model)
{
   {
...
void CNMSSMEFTHiggs_slha_io::set_mass(const standard_model::Standard_model_physical& physical)
{
   std::ostringstream mass;
...
void CNMSSMEFTHiggs_slha_io::set_mixing_matrices(const standard_model::Standard_model_physical& physical)
{
...
void CNMSSMEFTHiggs_slha_io::set_spectrum(const standard_model::Standard_model& model)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double CNMSSMEFTHiggs_slha_io::get_parameter_output_scale() const
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::fill(CNMSSMEFTHiggs_input_parameters& input) const
{
 ...
 */
void CNMSSMEFTHiggs_slha_io::fill_drbar_parameters(CNMSSMEFTHiggs_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void CNMSSMEFTHiggs_slha_io::fill(CNMSSMEFTHiggs_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   CNMSSMEFTHiggs_physical physical_hk;
 ...
 */
void CNMSSMEFTHiggs_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void CNMSSMEFTHiggs_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void CNMSSMEFTHiggs_slha_io::fill_minpar_tuple(CNMSSMEFTHiggs_input_parameters& input,
...
void CNMSSMEFTHiggs_slha_io::fill_extpar_tuple(CNMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CNMSSMEFTHiggs_slha_io::fill_imminpar_tuple(CNMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void CNMSSMEFTHiggs_slha_io::fill_imextpar_tuple(CNMSSMEFTHiggs_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void CNMSSMEFTHiggs_slha_io::fill_physical(CNMSSMEFTHiggs_physical& physical) const
{
   {
 ...
 */
double CNMSSMEFTHiggs_slha_io::read_scale() const
{
