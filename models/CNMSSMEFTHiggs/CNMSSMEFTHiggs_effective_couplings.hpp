...
#ifndef CNMSSMEFTHiggs_EFFECTIVE_COUPLINGS_H
#define CNMSSMEFTHiggs_EFFECTIVE_COUPLINGS_H
...
class CNMSSMEFTHiggs_effective_couplings {
public:
   CNMSSMEFTHiggs_effective_couplings(const CNMSSMEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const CNMSSMEFTHiggs_mass_eigenstates& model_);
