...
#ifndef CNMSSMEFTHiggs_susy_parameters_H
#define CNMSSMEFTHiggs_susy_parameters_H
...
class CNMSSMEFTHiggs_susy_parameters : public Beta_function {
public:
   explicit CNMSSMEFTHiggs_susy_parameters(const CNMSSMEFTHiggs_input_parameters& input_ = CNMSSMEFTHiggs_input_parameters());
   CNMSSMEFTHiggs_susy_parameters(double scale_, int loops_, int thresholds_, const CNMSSMEFTHiggs_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_,
   ...
   CNMSSMEFTHiggs_susy_parameters(const CNMSSMEFTHiggs_susy_parameters&) = default;
   CNMSSMEFTHiggs_susy_parameters(CNMSSMEFTHiggs_susy_parameters&&) = default;
   virtual ~CNMSSMEFTHiggs_susy_parameters() = default;
   CNMSSMEFTHiggs_susy_parameters& operator=(const CNMSSMEFTHiggs_susy_parameters&) = default;
   CNMSSMEFTHiggs_susy_parameters& operator=(CNMSSMEFTHiggs_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const CNMSSMEFTHiggs_input_parameters& get_input() const;
   CNMSSMEFTHiggs_input_parameters& get_input();
   void set_input_parameters(const CNMSSMEFTHiggs_input_parameters&);

   CNMSSMEFTHiggs_susy_parameters calc_beta() const;
   CNMSSMEFTHiggs_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const CNMSSMEFTHiggs_susy_parameters&);
