...
#ifndef CNMSSMEFTHiggs_INFO_H
#define CNMSSMEFTHiggs_INFO_H
...
namespace CNMSSMEFTHiggs_info {
   ...
   class CNMSSMEFTHiggs_particle_names : public Names {
   public:
      virtual ~CNMSSMEFTHiggs_particle_names() = default;
   ...
   class CNMSSMEFTHiggs_parameter_names : public Names {
   public:
      virtual ~CNMSSMEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const CNMSSMEFTHiggs_particle_names  particle_names_getter{};
   const CNMSSMEFTHiggs_parameter_names parameter_names_getter{};
