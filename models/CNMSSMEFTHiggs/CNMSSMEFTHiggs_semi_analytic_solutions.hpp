...
/**
 * @file CNMSSMEFTHiggs_semi_analytic_solutions.hpp
...
#ifndef CNMSSMEFTHiggs_SEMI_ANALYTIC_SOLUTIONS_H
#define CNMSSMEFTHiggs_SEMI_ANALYTIC_SOLUTIONS_H
...
class CNMSSMEFTHiggs_semi_analytic_solutions {
public:
   CNMSSMEFTHiggs_semi_analytic_solutions();
   CNMSSMEFTHiggs_semi_analytic_solutions(
      const CNMSSMEFTHiggs_semi_analytic_solutions&) = default;
   CNMSSMEFTHiggs_semi_analytic_solutions(
      CNMSSMEFTHiggs_semi_analytic_solutions&&) = default;
   ~CNMSSMEFTHiggs_semi_analytic_solutions() = default;
   CNMSSMEFTHiggs_semi_analytic_solutions& operator=(
      const CNMSSMEFTHiggs_semi_analytic_solutions&) = default;
   CNMSSMEFTHiggs_semi_analytic_solutions& operator=(
      CNMSSMEFTHiggs_semi_analytic_solutions&&) = default;
    ...
    */
   void calculate_coefficients(const CNMSSMEFTHiggs_mass_eigenstates&);
    ...
    */
   void evaluate_solutions(CNMSSMEFTHiggs_mass_eigenstates&) const;
...
private:
   ...
   void calculate_trial_data(const CNMSSMEFTHiggs_mass_eigenstates&);
   void set_to_boundary_values(CNMSSMEFTHiggs_mass_eigenstates&,
                               const Boundary_values&) const;
   CNMSSMEFTHiggs_mass_eigenstates run_to_output_scale(
      const CNMSSMEFTHiggs_mass_eigenstates&, const Boundary_values&) const;
...
template <class MatrixType, int BasisSize, class BasisEvaluator>
Eigen::JacobiSVD<MatrixType> CNMSSMEFTHiggs_semi_analytic_solutions::create_solver(
   const CNMSSMEFTHiggs_semi_analytic_solutions::Data_vector_t& data,
