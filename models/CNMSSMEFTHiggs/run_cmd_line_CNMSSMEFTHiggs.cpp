...
{
   std::cout <<
      "Usage: run_cmd_line_CNMSSMEFTHiggs.x [options]\n"
      "Options:\n"
      "  --m12=<value>\n"
      "  --TanBeta=<value>\n"
      "  --SignvS=<value>\n"
...
int run_solver(const CNMSSMEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(CNMSSMEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const CNMSSMEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
