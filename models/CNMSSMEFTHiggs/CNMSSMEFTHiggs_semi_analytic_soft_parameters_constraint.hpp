...
#ifndef CNMSSMEFTHiggs_SEMI_ANALYTIC_SOFT_PARAMETERS_CONSTRAINT_H
#define CNMSSMEFTHiggs_SEMI_ANALYTIC_SOFT_PARAMETERS_CONSTRAINT_H

#include "CNMSSMEFTHiggs_input_parameters.hpp"
#include "CNMSSMEFTHiggs_soft_parameters_constraint.hpp"
...
template<>
class CNMSSMEFTHiggs_soft_parameters_constraint<Semi_analytic> : public Single_scale_constraint {
public:
   using Scale_getter = std::function<double()>;

   CNMSSMEFTHiggs_soft_parameters_constraint() = default;
   CNMSSMEFTHiggs_soft_parameters_constraint(CNMSSMEFTHiggs<Semi_analytic>*, const softsusy::QedQcd&);
   virtual ~CNMSSMEFTHiggs_soft_parameters_constraint() = default;

   virtual void apply() override;
   virtual double get_scale() const override { return scale; }
   virtual std::string name() const override { return "CNMSSMEFTHiggs soft parameters constraint"; }
