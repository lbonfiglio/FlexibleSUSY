...
/**
 * @file CNMSSMEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef CNMSSMEFTHiggs_MASS_EIGENSTATES_H
#define CNMSSMEFTHiggs_MASS_EIGENSTATES_H
 ...
 */
class CNMSSMEFTHiggs_mass_eigenstates : public CNMSSMEFTHiggs_soft_parameters {
public:
   explicit CNMSSMEFTHiggs_mass_eigenstates(const CNMSSMEFTHiggs_input_parameters& input_ = CNMSSMEFTHiggs_input_parameters());
   CNMSSMEFTHiggs_mass_eigenstates(const CNMSSMEFTHiggs_mass_eigenstates&) = default;
   CNMSSMEFTHiggs_mass_eigenstates(CNMSSMEFTHiggs_mass_eigenstates&&) = default;
   virtual ~CNMSSMEFTHiggs_mass_eigenstates() = default;
   CNMSSMEFTHiggs_mass_eigenstates& operator=(const CNMSSMEFTHiggs_mass_eigenstates&) = default;
   CNMSSMEFTHiggs_mass_eigenstates& operator=(CNMSSMEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_physical(const CNMSSMEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const CNMSSMEFTHiggs_physical& get_physical() const;
   CNMSSMEFTHiggs_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<CNMSSMEFTHiggs_ewsb_solver_interface>&);
   ...
   double get_lsp(CNMSSMEFTHiggs_info::Particles&) const;
...
private:
   ...
   CNMSSMEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{CNMSSMEFTHiggs_info::model_name,
                     &CNMSSMEFTHiggs_info::particle_names_getter,
                     &CNMSSMEFTHiggs_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<CNMSSMEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const CNMSSMEFTHiggs_mass_eigenstates&);
