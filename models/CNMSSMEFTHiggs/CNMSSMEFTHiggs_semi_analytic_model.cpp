...
/**
 * @file CNMSSMEFTHiggs_semi_analytic_model.cpp
...
#define CLASSNAME CNMSSMEFTHiggs<Semi_analytic>

#define COEFFICIENT(coefficient) solutions.get_##coefficient()
#define INPUTPARAMETER(parameter) model.get_input().parameter
#define MODELPARAMETER(parameter) model.get_##parameter()

CLASSNAME::CNMSSMEFTHiggs(const CNMSSMEFTHiggs_input_parameters& input_)
   : CNMSSMEFTHiggs_mass_eigenstates(input_)
{
}

void CLASSNAME::calculate_spectrum()
{
   CNMSSMEFTHiggs_mass_eigenstates::calculate_spectrum();
}

void CLASSNAME::clear_problems()
{
   CNMSSMEFTHiggs_mass_eigenstates::clear_problems();
}

std::string CLASSNAME::name() const
{
   return CNMSSMEFTHiggs_mass_eigenstates::name();
}

void CLASSNAME::run_to(double scale, double eps)
{
   CNMSSMEFTHiggs_mass_eigenstates::run_to(scale, eps);
}

void CLASSNAME::print(std::ostream& out) const
{
   CNMSSMEFTHiggs_mass_eigenstates::print(out);
   out << "----------------------------------------\n"
...
{
   CNMSSMEFTHiggs_mass_eigenstates::set_precision(p);
}

const CNMSSMEFTHiggs_semi_analytic_solutions& CLASSNAME::get_semi_analytic_solutions() const
{
   return solutions;
}

CNMSSMEFTHiggs_semi_analytic_solutions& CLASSNAME::get_semi_analytic_solutions()
{
   return solutions;
}
...
std::ostream& operator<<(std::ostream& ostr, const CNMSSMEFTHiggs<Semi_analytic>& model)
{
   model.print(ostr);
   return ostr;
}
