...
/**
 * @file CNMSSMEFTHiggs_semi_analytic_model.hpp
...
#ifndef CNMSSMEFTHiggs_SEMI_ANALYTIC_MODEL_H
#define CNMSSMEFTHiggs_SEMI_ANALYTIC_MODEL_H
...
class Semi_analytic;
/**
 * @class CNMSSMEFTHiggs<Semi_analytic>
 * @brief model class with routines for determining masses and mixings and EWSB
 */
template<>
class CNMSSMEFTHiggs<Semi_analytic> : public Model, public CNMSSMEFTHiggs_mass_eigenstates {
public:
   explicit CNMSSMEFTHiggs(const CNMSSMEFTHiggs_input_parameters& input_ = CNMSSMEFTHiggs_input_parameters());
   CNMSSMEFTHiggs(const CNMSSMEFTHiggs&) = default;
   CNMSSMEFTHiggs(CNMSSMEFTHiggs&&) = default;
   virtual ~CNMSSMEFTHiggs() = default;
   CNMSSMEFTHiggs& operator=(const CNMSSMEFTHiggs&) = default;
   CNMSSMEFTHiggs& operator=(CNMSSMEFTHiggs&&) = default;
    ...
    */
   const CNMSSMEFTHiggs_semi_analytic_solutions& get_semi_analytic_solutions() const;
    ...
    * @return the current set of semi-analytic solutions
    */
   CNMSSMEFTHiggs_semi_analytic_solutions& get_semi_analytic_solutions();
...
std::ostream& operator<<(std::ostream&, const CNMSSMEFTHiggs<Semi_analytic>&);
