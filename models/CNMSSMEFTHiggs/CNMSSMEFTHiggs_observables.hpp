...
#ifndef CNMSSMEFTHiggs_OBSERVABLES_H
#define CNMSSMEFTHiggs_OBSERVABLES_H
...
CNMSSMEFTHiggs_observables calculate_observables(
   CNMSSMEFTHiggs_mass_eigenstates&, const softsusy::QedQcd&,
