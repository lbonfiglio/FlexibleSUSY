Get["models/CNMSSMEFTHiggs/CNMSSMEFTHiggs_librarylink.m"];

handle = FSCNMSSMEFTHiggsOpenHandle[
    fsSettings -> {
...
spectrum    = FSCNMSSMEFTHiggsCalculateSpectrum[handle];
observables = FSCNMSSMEFTHiggsCalculateObservables[handle];
FSCNMSSMEFTHiggsCloseHandle[handle];
