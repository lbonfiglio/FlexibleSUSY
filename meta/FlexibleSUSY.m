...
";
           ...
           WriteOut`ReplaceInFiles[files,
                          { "@lspGetters@"           -> IndentText[lspGetters],
                            ...
                            "@usingSuperParameterGetters@" -> IndentText[FunctionModifiers`MakeOverride[StringJoin[Parameters`CreateUsingParameterGetter[#, FlexibleSUSY`FSModelName <> "_soft_parameters"]& /@ Parameters`GetModelParameters[]]]],
                            "@usingSuperParameterSetters@" -> IndentText[FunctionModifiers`MakeOverride[StringJoin[Parameters`CreateUsingParameterSetter[#, FlexibleSUSY`FSModelName <> "_soft_parameters"]& /@ Parameters`GetModelParameters[]]]],
